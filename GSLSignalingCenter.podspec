#
#  Be sure to run `pod spec lint GSLSignalingCenter.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/wangtongvip/GSLSignalingCenter.git", :tag => spec.version }
  ...
  spec.source_files  = "GSLSignalingCenterFramework.framework/Headers/*.h"
  #  spec.exclude_files = "Classes/Exclude"

  spec.public_header_files = "GSLSignalingCenterFramework.framework/Headers/*.h"
