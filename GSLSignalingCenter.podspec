...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/wangtongvip/GSLSignalingCenter.git", :tag => "v1.1.1" }
  ...
  spec.vendored_libraries  = "GSLSignalingCenter/GSLSignalingCenterDemo/GSLSignalingCenterFramework"
